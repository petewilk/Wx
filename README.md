...
Plots the rate of change of day length (hours of daylight gained/lost per day) across the year for a given location, using [NOAA's solar calculator formulas](https://gml.noaa.gov/grad/solcalc/calcdetails.html).
